			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="panel panel-default">
						...
						<div class="panel-heading"> <h4>Return a Car</h4></div>
						...
						<div class="panel-body">
							...
							<%
								...
								String sql = "select rents.VehicleID, rents.ID, customer.CustType, TRIM(BOTH ' ' FROM CONCAT_WS(' ', Fname, Lname, Cname)) as customerName, car.model, ";
									...
									<tbody>
									    <% while(rs.next()) { %>
									       <tr>
												...
												<td> <a href="carRentServlet?VehicleID=<%= rs.getInt("VehicleID") %>&ID=<%= rs.getInt("ID") %>">Return Car</a> </td>
											</tr>
									    <% }
									    	con.close();
									    	stmt.close();
